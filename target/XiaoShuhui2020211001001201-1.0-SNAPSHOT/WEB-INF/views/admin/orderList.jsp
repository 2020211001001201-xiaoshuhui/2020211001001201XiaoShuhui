			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<td>${o.orderDate}</td>
						<%
							com.XiaoShuhui.model.Order o=(com.XiaoShuhui.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.XiaoShuhui.dao.UserDao userDao=new com.XiaoShuhui.dao.UserDao();
						...
						<%
							...
							String paymentType=com.XiaoShuhui.model.Payment.findByPaymentId(con,n);
							 %>
